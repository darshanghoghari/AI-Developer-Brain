...
## 🎯 Purpose & Scope
When tasked with a complex feature request, an AI coding assistant left without verification will often hallucinate requirements or implement generalized design patterns that conflict with the human developer's vision. 
...
1. **Analyze Local Context**: Search existing file symbols and review `.ai-brain/project-identity.md` and `.ai-brain/domain-rules-and-vocabulary.md` within the target project repository.
